...
label luna_chitdom_0_1:
    m "Как твои дела, [luna_name]?"
    call luna_main("Достаточно хороши, [l_genie_name]...", 8, 2, 2, 3) 
    call luna_main("Но определенно могли быть лучше!", 9, 1, 2, 2) 
    return
