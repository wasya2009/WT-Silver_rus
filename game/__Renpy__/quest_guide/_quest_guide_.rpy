...
screen guide:
    ...
    imagemap:
        ...
        text "Квесты" xalign 0.5 ypos 100 size 26
        ...
        #Quest Objctive
        text "- Цель -" xpos 400 ypos 165 size 12
        if guide_page == 0:
        ...
        #Quest Hint
        text "- Намек -" xpos 400 ypos 210 size 12
        if guide_show_hint:
            if guide_page == 0:
        ...
        #Quest Next Step
        text "- Следующий шаг -" xpos 400 ypos 310 size 12
        ...
        #Tip/Fact of the Day-советы
        if guide_add_tip:
            text "- Совет дня -" xpos 400 ypos 410 size 12
        else:
            text "- Факт дня -" xpos 400 ypos 410 size 12
